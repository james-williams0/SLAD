    ...
    public void draw(Graphics g, JPanel c){
        ...
        if(size() > 0) {
            for(Booking booking : this) {
                ...
                g.drawRect(i, j, k, l);
                g.drawString("Name: " + booking.getName(), i + 20, j + (l / 2));
                j += 35;
                g.drawString("Date: " + booking.getDate(), i + 20, j + (l / 2));
                j += 35;
                g.drawString("Time: " + booking.getTime(), i + 20, j + (l / 2));
                j += 35;
                g.drawString("Number of people: " + booking.getNumOfPeople(), i + 20, j + (l / 2));
                j += 35;
                g.drawString("Table number: " + booking.getTable(), i + 20, j + (l / 2));
                j += 35;
                g.drawString("Details: " + booking.getDetails(), i + 20, j + (l / 2));
                j += 35;
            }
        }
    }
